...
class Map:
    def __init__(self):
        ...
        self.__width = 13 * 4
        self.__height = 13 * 4
        self.__map: list[list[MapObject | None]] = [
            [None for _ in range(self.__width)] for _ in range(self.__height)]
        self.__layers = []
    ...
    def __setitem__(self, position, map_object):
        ...
        if isinstance(map_object, CompoundMapObject):
            ...
            if map_object.layer not in self.__layers:
                self.__layers.append(map_object.layer)
    ...
    def __contains__(self, position):
        ...
        if isinstance(position, MapPositionCollection):
            ...
            return -1 < position.y < self.__width and -1 < position.x < self.__width

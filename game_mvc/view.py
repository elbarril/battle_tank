...
menu_frame = game_view.set_menu_frame(mode_manager.all_modes, mode_manager.mode)
...
menu_down_bind = game_view.bind(TK_KEYBOARD.DOWN, lambda e:mode_manager.set_two_players())
menu_up_bind = game_view.bind(TK_KEYBOARD.UP, lambda e:mode_manager.set_one_player())
